...
class MarcusModelTester:
    def __init__(self, model_name="iwswordpress/marcus-tinyllama-finetune-with-fact"):
...
def main():
    ...
    try:
        ...
        print(
            "Make sure your model is uploaded to HuggingFace Hub and your HF_TOKEN is valid."
        )
